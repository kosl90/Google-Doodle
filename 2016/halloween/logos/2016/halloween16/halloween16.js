(function() {
	...
	var qb = function(a) {
			...
			a = "/gen_204?atyp=i&ct=doodle&cad=" + a + d + "&zx=" + pa();
		...
		$c = function(a, b) {
			...
			if (!Dc) {
				...
				if (!(0 > d.keyCode || void 0 != d.returnValue)) {
					...
					for (e = 0; !b.w && e < d.length; e++) b.s = d[e],
					f = ed(d[e], a, !1, b),
					c = c && f
				}
				return c
	...
	ge.prototype.unlisten = function(a, b, c, d) {
		...
		if (a in e.o) {
			var f = e.o[a];
			b = Nc(f, b, c, d); - 1 < b ? (Lc(f[b]), Array.prototype.splice.call(f, b, 1), 0 == f.length && (delete e.o[a], e.s--), e = !0) : e = !1
		} else e = !1;
		return e
	};
	...
	m(Se, Ge);
	var w = {
			Ga: new Re("/logos/2016/halloween16/", "main"),
			Rc: new Re("/logos/2016/halloween16/", "initial"),
			yc: new Re("/logos/2016/halloween16/", "victory"),
			vb: new Re("/logos/2016/halloween16/", "end")
		},
		x = {
	...
	var Xe = function() {
		Te.call(this, "/logos/2016/halloween16/", We)
	};
	m(Xe, Te);
	var We = [{
